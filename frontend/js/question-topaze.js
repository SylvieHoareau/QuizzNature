 ...
 // URL de l'API
 const url = "http://localhost:1337/api/quizzes/16/?populate=questions";
 let score = 0;
 ...
 // const checkQuizzResult = () => {
 //     const totalQuestions = document.querySelectorAll('.question').length;
 //     if (score === totalQuestions && score === 5) {
 //         alert("Bonne réponse !");
 //     } else {
 ...
 const validateAnswer = (questionName, correctAnswer, index) => {
     ...
     // Vérifie le résultat du quizz après chaque réponse
     // checkQuizzResult();